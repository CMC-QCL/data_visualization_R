...
To make a histogram you can use the `geom_col()` function. Let's make a bar plot of the totals of every genre; there will be some data wrangling involved.
...
You can download your project and run this tutorial on your own computer.
